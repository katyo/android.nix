{ stdenv, fetchurl, fetchFromGitHub, unzip, version ? "2.9.2" }:
...
let
  ...
  in {
    ...
    "2.9.2-x86_64-linux" = fetchurl {
      url = "${base}/${stable_version}/release/${version}/sdk/dartsdk-linux-${x86_64}-release.zip";
      sha256 = "08lnb78cl3g86ypzvz75c9pscakw68m2glhda3155y6l97y4a6kw";
    };
    "2.9.2-i686-linux" = fetchurl {
      url = "${base}/${stable_version}/release/${version}/sdk/dartsdk-linux-${i686}-release.zip";
      sha256 = "1rmvimfzfn3pd3wfmwm9ksvq2ypw8qm46rpfxnhxzz223y7l2v45";
    };
    "2.9.2-aarch64-linux" = fetchurl {
      url = "${base}/${stable_version}/release/${version}/sdk/dartsdk-linux-${aarch64}-release.zip";
      sha256 = "188ri47r0wfx59s3kqz9284b28wq6mmzq35hnvhcaxxgidffkydl";
    };
  };
